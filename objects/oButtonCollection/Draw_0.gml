// === oButtonCollection - Draw Event ===
// Dessine un cadre neutre avec le texte "Collection"
...
draw_text_transformed(x + 2, y + 2, "Collection", sc, sc, 0);

// Dessiner le texte "Collection" centré en crème dorée
draw_set_color(make_color_rgb(230, 200, 120));
draw_text_transformed(x, y, "Collection", sc, sc, 0);
