// === oButtonCollection - Step Event ===
// Détection manuelle des clics sur le bouton Collection
...
if (mouse_check_button_pressed(mb_left)) {
    ...
    if (mouse_x_pos >= button_left && mouse_x_pos <= button_right && 
        ...
        show_debug_message("### oButtonCollection.Step_0 - Clic détecté dans la zone du bouton!");
        ...
        show_debug_message("### Navigation vers rCollection depuis rAcceuil");
        
        // Naviguer vers la room Collection
