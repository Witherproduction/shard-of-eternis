// === oButtonMode - Draw Event ===
// Dessine un cadre neutre avec le texte "Mode"
...
var text_scale = 0.5;
draw_text_transformed(x + 2, y + 2, "Mode", text_scale, text_scale, 0);

// Dessiner le texte "Mode" centré en crème dorée
draw_set_color(make_color_rgb(230, 200, 120));
draw_text_transformed(x, y, "Mode", text_scale, text_scale, 0);
