...
if (mouse_check_button_pressed(mb_left)) {
    ...
    if (mouse_x_pos >= button_left && mouse_x_pos <= button_right && 
        ...
        show_debug_message("### oChoixChallenge.Step_0 - Clic détecté dans la zone du bouton!");
        ...
        show_debug_message("### Navigation vers rChallenge depuis " + string(room_get_name(room)));
