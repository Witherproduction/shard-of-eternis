...
show_debug_message("### oStoryCarousel: Global clic detecte");
...
show_debug_message("### oStoryCarousel: bouton rect = (" + string(btn_x1) + "," + string(btn_y1) + ")- (" + string(btn_x2) + "," + string(btn_y2) + ")");
show_debug_message("### oStoryCarousel: souris = (" + string(mouse_x) + "," + string(mouse_y) + ")");
...
if (click_start || click_center_panel) {
    show_debug_message("### oStoryCarousel: clic sur Commencer (global)");
    var chap_id = index + 1;
